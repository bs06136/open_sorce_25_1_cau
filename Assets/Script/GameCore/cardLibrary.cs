...
namespace CardGame
{
    public static class CardLibrary
    {
        ...
        {
            // 문서 순서대로 (0~40) - 원본 문서 기준으로 정확히 수정
            ...
            new Card("여제", 1, 0, "덱의 죽음 카드 5장 제거", CardEffect.EmpressEffect),
            ...
            new Card("운명의 수레바퀴", 0, 0, "체력↔저주 5:1 비율 교환", CardEffect.FortuneWheelEffect),
            new Card("정의", 0, 0, "체력+저주 합계 5:1 재분배", CardEffect.JusticeEffect),
            new Card("매달린 남자", 5, 0, "다음 턴 2장만 뽑음", CardEffect.HangedManEffect),
            new Card("죽음", 0, 0, "게임 종료", CardEffect.DeathEffect),
            new Card("절제", -5, 0, "다음 2턴 저주 피해 0", CardEffect.TemperanceEffect),
            new Card("악마", 20, 5, ""),
            new Card("탑", -1, 0, "다음 턴 스킵", CardEffect.TowerEffect),
            new Card("별", 2, 0, ""),
            new Card("달", -10, -2, ""),
            new Card("태양", 10, 2, ""),
            new Card("심판", -3, -1, "덱에서 무작위 5장 제거", CardEffect.JudgementEffect),
            new Card("세계", 7, -3, "뽑힌 모든 카드 효과 적용", CardEffect.WorldEffect),
            new Card("부활", -1, 0, "덱의 모든 죽음 카드 삭제", CardEffect.ReviveEffect),
            new Card("생명", 0, 0, "덱에 무작위 카드 20장 추가", CardEffect.LifeEffect),
            new Card("악동", 0, 1, "체력 1~10 무작위 증가", CardEffect.ScampEffect),
            ...
            new Card("불씨", -1, 1, "체력1이하시 체력1·저주0 고정", CardEffect.EmberEffect),
            new Card("저주받은 책", 0, 1, ""),
            new Card("예언자", -3, 1, "다음 턴 체력감소&저주증가 무효", CardEffect.ProphetEffect),
            new Card("종말의 경전", 0, 3, "덱 리셋", CardEffect.ApocalypseScriptureEffect),
            new Card("강탈자", -3, 0, ""),
            new Card("대천사", 1, -1, "다음 턴 죽음카드→랜덤카드 교체", CardEffect.ArchangelEffect),
            ...
            new Card("피의 서약", -10, 0, "다음 2턴 저주 증가 무효", CardEffect.BloodPactEffect),
