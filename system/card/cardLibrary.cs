...
namespace CardGame
{
    public static class CardLibrary
    {
        public static List<Card> AllCards = new List<Card>
        {
            ...
            new Card("세계", 7, -3, "모든 카드 효과 적용", null), // 특수한 처리 (Game 내에서)
